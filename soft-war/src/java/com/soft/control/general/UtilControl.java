...
import com.soft.util.Cadena;
import com.soft.util.EncodeDecode;
import com.soft.util.EncryptionUtil;
import com.soft.util.HtmlUtil;
...
public class UtilControl {
    ...
    public String htmlReplaceSaltoLinea(String txt) {
        return HtmlUtil.removeSpecialTags(txt.replaceAll("\n", "<br/>"));
    }
}
