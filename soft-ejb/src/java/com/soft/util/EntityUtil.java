...
public class EntityUtil {
    ...
    public static void main(String[] args) {
        System.out.println(getAttrHqlToSql("name", Person.class));
        System.out.println(getTableName(Person.class));
        System.out.println(getAttrId(Person.class));
        System.out.println(getAttrIdClass(Person.class));
        System.out.println(getAttrId_SqlName(Person.class));
    }
}
